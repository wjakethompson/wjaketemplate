...
[![Check accessibility](https://img.shields.io/badge/check-accessibility-orange.svg)](https://wave.webaim.org/report#/https://wjaketemplate.wjakethompson.com)
<!-- badges: end -->

## Overview

wjaketemplate provides a custom [pkgdown](https://pkgdown.r-lib.org) template for my personal packages. Please don't use it for your own package.
